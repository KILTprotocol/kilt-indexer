...
You can watch the three services start (it may take a few minutes on first start). Once all are running, you can head to http://localhost:3000 in your browser and you should see a [GraphQL Playground](https://academy.subquery.network/indexer/run_publish/query/graphql.html) showing with the schemas ready to query.
